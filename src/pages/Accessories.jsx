...
import { accessoriesbanner } from "../assets/accessories/accessories";
          ...
          <section className="w-full">
            <div className="flex items-center justify-between w-full ">
              ...
              <div className="w-full text-center md:text-start text-xs ">
                {clothing.filter((cart) => cart.accessories === true).length} items
              </div>
            ...
            <main className="newArrivals w-full mt-5">
              {clothing
                .filter((cart) => cart.accessories === true)
                .map((seller) => (
